  ...
  <div class="">
    <el-row>
      <el-form :inline="true" :model="paramJson" class="caseList-form" label-width="100px">
        ...
        <el-col :span="8">
          <el-form-item label="案件阶段类型">
            <el-select size="small" v-model="paramJson.stageType" placeholder="请选择">
        ...
        <el-col :span="8">
          <el-form-item label="案件类型">
            <el-select size="small" v-model="paramJson.caseType" placeholder="请选择">
    ...
    <el-row>
      <template>
        <el-table :data="tableData" highlight-current-row @row-click="handleRow" style="width: 100%">
          ...
          <el-table-column prop="stageType" label="案件阶段类型" width="120" align="center"></el-table-column>
          <el-table-column prop="caseType" label="案件类型" align="center"></el-table-column>
          <el-table-column prop="stagePeriod" label="案件阶段周期" align="center"></el-table-column>
          <el-table-column prop="state" label="是否禁用" width="100" align="center"></el-table-column>
          <el-table-column prop="rowAddUser" label="添加人员" align="center"></el-table-column>
        </el-table>
      </template>
      <div class="pag-index">
        <el-pagination
