...
<template>
  <div class="caseList">
      ...
      <el-form :inline="true" :model="paramJson" class="caseList-form">
        ...
        <el-col :span="6">
          <el-form-item label="处理人">
            <el-input size="small" v-model="paramJson.collcectionName" placeholder="处理人"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="所属组">
            <el-select size="small" v-model="paramJson.groupId" placeholder="请选择">
        ...
        <el-col :span="6">
          <el-form-item label="所属机构">
            <el-select size="small" v-model="paramJson.deputeOrgId" placeholder="请选择">
        ...
        <!--<el-col :span="6">-->
          <!--<el-form-item label="案件状态">-->
            <!--<el-select size="small" v-model="paramJson.caseStatus" placeholder="请选择">-->
    ...
    <el-row class="btn-group">
      ...
      <el-button class="mb10" size="small" type="primary" @click="clickEvent(2)">处理</el-button>
      <el-button class="mb10" size="small" type="primary" @click="clickEvent(3)">导出</el-button>
      <el-button class="mb10" size="small" type="primary" @click="clickEvent(4)">分配</el-button>
      <el-button class="mb10" size="small" type="primary" @click="clickEvent(5)">导入分配</el-button>
      <el-button class="mb10" size="small" type="primary" @click="clickEvent(6)">委外</el-button>
      <el-button class="mb10" size="small" type="primary" @click="clickEvent(7)">导入委外</el-button>
      <el-button class="mb10" size="small" type="primary" @click="clickEvent(8)">操作日志</el-button>
    ...
    <el-row>
      <template>
        <el-table :data="tableData" highlight-current-row @row-click="handleRow" style="width: 100%">
          ...
          <el-table-column prop="caseStatuName" label="案件状态" width="100" align="center"></el-table-column>
          <el-table-column prop="dispatcherStateName" label="分派状态" width="100" align="center"></el-table-column>
          ...
          <el-table-column prop="termCurrent" label="当前逾期期数" width="180" align="center"></el-table-column>
          <el-table-column prop="termTotle" label="累计逾期期数" width="180" align="center"></el-table-column>
          <el-table-column prop="termContinuous" label="连续逾期期数" width="180" align="center"></el-table-column>
          <el-table-column prop="termHigh" label="最高逾期期数" width="180" align="center"></el-table-column>
    ...
    <case-allot v-if="showAllot" :currentData="currentRow" :groupData="allGroup"></case-allot>
    <case-outsource v-if="showOutsource" :currentData="currentRow" :orgData="deputeOrg"></case-outsource>
  </div>
</template>
<script>
  import caseAllot from './caseAllot.vue'
  import caseOutsource from './caseOutsource.vue'
...
//      that.getCollectionState()
    ...
    methods: {
      ...
      submitQuery () {   //查询
        ...
        that.$axios.post(api + "/ngcos/collectionCaseQuery/queryCaseList", sendJson).then(function (res) {
          let result = res.data
          if (result.code == "200") {
      ...
      clickEvent (type) {
        ...
        switch (type) {
          ...
          case 5:
            //导入分配
            that.dialogTit = "导入分配"
            that.importUrl = api + "/ngcos/allot/manualAllotCase"
            that.showDialog = true
            break;
          case 6:
            //委外
            if (that.caseId) {
              that.showOutsource = true
            } else {
              that.$message.error('请先选择一项案件')
            }
            break;
